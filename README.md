...
Notes untuk fondasi security, networking, Linux, Windows, Windows Server, Active Directory, HTTP, dan security operations.

Terima kasih sudah membaca.

Semoga notes ini bermanfaat untuk siapa pun yang sedang membangun fondasi security dengan serius.
